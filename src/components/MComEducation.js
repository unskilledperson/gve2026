          ...
          <div className="mcom-bottom-container">
            ...
            >
              ...
              <div className="mcom-about-card-header">
                <img src={aboutOverlay} alt="Program Icon" className="mcom-about-icon education-about-icon" />
              ...
              <div className="mcom-info-card career-prospects-card">
                <div className="mcom-about-card-header">
                  <img src={careerOverlay} alt="Career Icon" className="mcom-about-icon no-bg-icon animate-bounce-subtle education-career-icon" />
            ...
            >
              ...
              <div className="mcom-about-card-header">
                <img src={eligibilityOverlay} alt="Eligibility Icon" className="mcom-about-icon small-icon education-eligibility-icon" />
